      ...
      default:
        ...
        if(idx){
          ...
          if(fs.existsSync(path.join(process.cwd(), 'node_modules/webpack')) && fs.existsSync(path.join(process.cwd(), 'node_modules/webpack'))){
            ...
            printLine('make sure you had installed webpack and webpack-dev-server，waiting for a few minutes...');
            var exec = require('child_process').exec; 
            var cmdStr = 'npm install webpack@1.13.3 --registry=http://r.cnpmjs.org && npm install webpack-dev-server@1.14.1  --registry=http://r.cnpmjs.org';
